...
void PORT6_IRQHandler(void) {
    ...
    distanceLeft = countnotchesLeft * 0.165 * PI; //Calculate distance of Left wheel; no of notches* diameter of notches * PI where diameter of notches = 0.165
    // IF
...
void PORT4_IRQHandler(void) {
    ...
    distanceRight = countnotchesRight * 0.165 * PI; //Calculate distance of right wheel; no of notches* diameter of notches * PI where diameter of notches = 0.165
...
void TA3_0_IRQHandler(void){
    ...
    if(timerLeft == 1 || timerRight == 1){ //calculate for every 1 second
